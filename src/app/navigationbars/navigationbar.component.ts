import {
  Component, ElementRef, ViewChild, Input, OnInit, Renderer, AfterViewInit, HostListener,
  Renderer2
} from '@angular/core';
  ...
  ngAfterViewInit() {
    ...
    setTimeout(() => {
      ...
      if (!this.containerInside) {
        ...
        this.renderer.removeChild( this.container.nativeElement.parentElement, this.container.nativeElement);
